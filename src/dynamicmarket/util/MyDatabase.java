...
public abstract class MyDatabase {
    ...
    public void initializeDatabase(String driver, String url, String username,
	    String password, String isolation, boolean logging, boolean rebuild) {
	...
	input = input.replaceAll("\\{DIR\\}", this.javaPlugin.getDataFolder()
		.getPath().replaceAll("\\\\", "/")
		+ "/");
	input = input.replaceAll("\\{NAME\\}", this.javaPlugin.getDescription()
