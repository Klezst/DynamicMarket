...
public class Util
{
	 ...
	 * @author Klezst
	 */
	public static MaterialData getMaterialData(String arg) throws IllegalArgumentException // TODO: Add support for custom aliases via a utility plugin?
	{
		try
		{
			String[] id = arg.split(":");
	...
	public static Map<String, String> getProperties(String... args) throws IllegalArgumentException
	{
		...
		for (String arg : args)
		{
			...
			if (entry.length != 2)
			{
				throw new IllegalArgumentException(arg + " isn't a valid property!");
			}
